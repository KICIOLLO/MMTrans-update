function cal_mag_trans_NSS_ext(str_open,I0_ang,D0_ang,DirRes,SavFor,ext_para)

% 函数说明： 总强度磁异常 转换 归一化磁源强度（NSS）
...
DeltaT2NSS(Mat,Dx,Dy,I0_ang,D0_ang,Per,ext_para);


FulNamZG=[DirRes FilSep Nam '_NSS'];
load NSS;
NSS=RecMat(NSS,FulNamZG,RowGap,ColGap,Str,SavFor);
...
function DeltaT2NSS(Mat,Dx,Dy,I0_ang,D0_ang,Per,ext_para)
[NumRow,NumCol]=size(Mat);
...
% Calculate the NSS : start
GradTensor2NSS(Haxx,Haxy,Haxz,Hayx,Hayy,Hayz,Zax,Zay,Zaz,NumRow,NumCol);
